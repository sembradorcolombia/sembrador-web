...
Visitors want to know who leads the church. The `/acerca` page derives its leadership section from the authors already in the CMS, so a leader is described in one place and appears wherever they are relevant.
## Requirements
