...
The system SHALL render a footer at the bottom of all public pages with church information and quick links.

#### Scenario: Footer renders with church info
- **GIVEN** a user visits any public page
- **WHEN** the page loads
- **THEN** the Footer SHALL display the church name, a copyright notice with the current year, and quick navigation links

#### Scenario: Footer social links
- **GIVEN** the church has social media profiles
- **WHEN** the Footer renders
- **THEN** social media links (e.g., Instagram, YouTube) SHALL be displayed as icon links opening in a new tab
